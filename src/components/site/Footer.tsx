    ...
    <footer className="ink-section px-4 py-8 md:px-8 md:py-10">
      <div className="mx-auto w-full max-w-7xl overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] shadow-2xl">
        ...
        <div
          ...
          style={{ height: "clamp(4rem, 13vw, 13rem)" }}
        >
          <h2
            aria-hidden="true"
            className="select-none whitespace-nowrap text-center font-bold italic leading-[0.9] tracking-tight text-ink-foreground/20"
            style={{
